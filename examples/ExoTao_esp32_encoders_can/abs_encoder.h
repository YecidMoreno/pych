#ifndef HH_ABS_ENCODER_H
#define HH_ABS_ENCODER_H
// documentation
...
#define SCLK_PIN  18
#define CS_PIN    27
#define SPI_CLOCK 1000000  // 3 MHz

#define MAX_RESOLUTION 32768
const float NOISE_THRESHOLD = 6.0f * M_PI / 180.0f;
...
*/    
    ...
    public:
        ...
        void begin(gpio_num_t _cs, long int _spi_freq);
